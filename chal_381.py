...
def yahtzee_upper(dice):
	components = set(dice)
	return max([ x * dice.count(x) for x in components ])
...
print(yahtzee_upper([1654, 1654, 50995, 30864, 1654, 50995, 22747, 1654, 1654, 1654, 1654, 1654, 30864, 4868, 1654, 4868, 1654, 30864, 4868, 30864])) # => 123456

with open("yahtzee-upper-1.txt", "r") as infile:
	dice = [ int(x.strip()) for x in infile.readlines() ]
	print(yahtzee_upper(dice))
